#!/usr/bin/env python3
"""Remove backgrounds from all spaceship diorama images to make them transparent."""
...
INPUT_DIR = Path("public/diorama/v14-spaceship")
OUTPUT_DIR = Path("public/diorama/v14-spaceship-nobg")
